...
public class BeanAttributeInformation {
	...
	public Type getType() {
		if (cachedType == null) {
			cachedType = ClassUtils.substituteGenerics(getImplementationType(), beanInformation.getTypeVariableSubstitution());
		}
		return cachedType;
	}
	...
	public boolean isConcretion() {
		...
		return !ClassUtils.equalUptoRenaming(getType(), superType, beanInformation.getTypeVariableSubstitution());
	}
