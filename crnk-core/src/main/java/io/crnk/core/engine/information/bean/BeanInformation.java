...
public class BeanInformation {
	...
	private Map<Type, Type> typeVariableSubstitution;
	...
	public BeanInformation(Class implementationClass) {
		...
		this.typeVariableSubstitution = Collections.unmodifiableMap(ClassUtils.getTypeArguments(implementationClass));
	}
	...
	/* package-private */ Map<Type, Type> getTypeVariableSubstitution() {
		return typeVariableSubstitution;
	}
